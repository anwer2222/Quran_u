...
const SURAHS_DATABASE = [
  ...
  { id: 2, name: "لقمان", type: "مدنية", verses: 286, words: 6116, uniqueWords: 1810, order: 87, revelationNo: 87 },
...
const VERSES_DATABASE = [
  ...
  { text: "ذَلِكَ الْكِتَابُ لَا رَيْبَ ۛ فِيهِ ۛ هُدًى لِّلْمُتَّقِينَ", surah: "لقمان", verseNo: 2, textClean: "ذلك الكتاب لا ريب فيه هدى للمتقين" },
  { text: "اللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ", surah: "لقمان", verseNo: 255, textClean: "الله لا إله إلا هو الحي القيوم" },
  { text: "يَا أَيُّهَا النَّاسُ اعْبُدُوا رَبَّكُمُ الَّذِي خَلَقَكُمْ", surah: "لقمان", verseNo: 21, textClean: "يا أيها الناس اعبدوا ربكم الذي خلقكم" },
  { text: "شَهْرُ رَمَضَانَ الَّذِي أُنزِلَ فِيهِ الْقُرْآنُ هُدًى لِّلنَّاسِ", surah: "لقمان", verseNo: 185, textClean: "شهر رمضان الذي أنزل فيه القرآن هدى للناس" },
  ...
  { text: "إِنَّ اللَّهَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ", surah: "لقمان", verseNo: 20, textClean: "إن الله على كل شيء قدير" },
  { text: "إِنَّ اللَّهَ غَفُورٌ رَّحِيمٌ", surah: "لقمان", verseNo: 173, textClean: "إن الله غفور رحيم" }
];
