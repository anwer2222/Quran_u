...
export const HAMZA_TAXONOMY: Record<string, Record<string, Record<string, string[]>>> = {
  "الهمزتان": {
    "في كلمة واحدة": {
      ...
      "الاستفهامان": ["الهدف الأول", "الهدف الثاني"],
    },
    "في كلمتين": {
      "متفقتان": ["فتح", "كسر", "ضم"],
...
export const HAMZA_MOCK_DATA: HamzaRuleRecord[] = [
  {
    ...
    quranicExamples: [
      { id: "H068", surahName: "النمل", surah: "27", ayahNumber: 67, text: "أَئِذَا", ayah: "وَقَالَ ٱلَّذِينَ كَفَرُوٓاْ أَءِذَا كُنَّا تُرَٰبٗا وَءَابَآؤُنَآ أَئِنَّا لَمُخۡرَجُونَ",highlighted: [3] },
