...
export const HAMZA_MOCK_DATA: HamzaRuleRecord[] = [
  {
    ...
    quranicExamples: [
      { id: "H068", surahName: "النمل", surah: "27", ayahNumber: 67, text: "أَئِذَا", ayah: "وَقَالَ ٱلَّذِينَ كَفَرُوٓاْ أَءِذَا كُنَّا تُرَٰبٗا وَءَابَآؤُنَآ أَئِنَّا لَمُخۡرَجُونَ",highlighted: [3,7] },
